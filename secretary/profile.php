<?php
    ...
    if (isset($_POST['sec_edit'])) {
        ...
        if ($n_password == $n_c_password) {
            if ($query = mysqli_query($con, "UPDATE sec_accnts SET full_name = '$n_full_name', email_add = '$n_email_add', contact_num = '$n_contact_num', password = '$n_password' WHERE sec_id = '$sec_id'")){
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-10">
            <h1 class="display-2 text-white">Hello <?php echo $_SESSION['full_name'];?></h1>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="n_full_name" id="" class="form-control form-control-alternative"  value="<?php echo $_SESSION['full_name'];?>" required autofocus>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="number" name="n_contact_num" id="" class="form-control form-control-alternative"  value="<?php echo $_SESSION['contact_num'];?>" required autofocus>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
